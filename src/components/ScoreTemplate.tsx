...
const Score = ({score, prevScore, applyDropShadow}: ScoreProps) => {
  return (
    <div className={twMerge( clsx("rounded-lg py-2 px-5 w-fit rounded-full flex items-center justify-center h-14", applyDropShadow ? "border-3 border-solid border-sky-400 drop-shadow-sky-400/50 drop-shadow-[0_0_10px] bg-sky-700 text-gray-300" : "text-gray-400"))}>
